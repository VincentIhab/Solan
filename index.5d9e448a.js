...
})({"JYT3g":[function(require,module,exports) {
    ...
    typingInterval = setInterval(()=>{
        if (charIndex < content.length) {
            ...
            changeTimeout = setTimeout(()=>{
                changeQuestion();
            }, 3000); // Wait before changing to the next question
        }
...
function changeQuestion() {
    titleElement.style.animation = "fadeOutUp 1s forwards";
    contentWrapperElement.style.animation = "fadeOutUp 1s forwards";
    cursorElement.style.animation = "fadeOutUp 1s forwards";
    setTimeout(()=>{
...
},{}]},["JYT3g","l9hyy"], "l9hyy", "parcelRequire2ad4")
