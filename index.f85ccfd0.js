...
//     triggerHook: 0.1, // Trigger when the middle of the form-page enters the viewport
//     duration: "100%"  // Maintain the background color change throughout the form-page
//   })
//   .on("enter", () => {
//     gsap.to(document.body, { backgroundColor: "#1e0000", duration: 0.5 });
//   })
//   .on("leave", () => {
...
//     triggerHook: 0.5
//   })
//   .setTween(gsap.to(".form-page-container", { opacity: 1, scale: 1, duration: 0.2 }))
//   .addTo(controller);
// });
//   ////////////////////////
//   ////////////////////////
